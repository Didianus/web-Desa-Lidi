...
async function main() {
  ...
  const beritaData = [
    ...
    },
    {
      ...
      content:
        "Pemerintah Desa Lidi bekerja sama dengan Dinas Koperasi dan UMKM Kota Cimahi mengadakan pelatihan UMKM Digital. Pelatihan ini diikuti oleh 50 peserta dari berbagai bidang usaha seperti kuliner, kerajinan, dan pertanian.",
      authorId: admin.id,
      published: true,
    },
    {
