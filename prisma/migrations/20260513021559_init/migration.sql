...
CREATE TABLE `ProfilDesa` (
    ...
    `kecamatan` VARCHAR(191) NOT NULL DEFAULT 'Kecamatan Lidi',
    `kabupaten` VARCHAR(191) NOT NULL DEFAULT 'Kabupaten Lidi',
    `provinsi` VARCHAR(191) NOT NULL DEFAULT 'Nusa Tenggara Timur',
    `kodePos` VARCHAR(191) NOT NULL DEFAULT '12345',
    `sejarah` VARCHAR(191) NOT NULL DEFAULT 'Sejarah desa akan diisi oleh admin.',
    `visi` VARCHAR(191) NOT NULL DEFAULT 'Visi desa akan diisi oleh admin.',
    `misi` VARCHAR(191) NOT NULL DEFAULT 'Misi desa akan diisi oleh admin.',
    `kepalaDesa` VARCHAR(191) NOT NULL DEFAULT 'Pak Dedos',
    `sambutanKepalaDesa` VARCHAR(191) NOT NULL DEFAULT 'Sambutan kepala desa akan diisi oleh admin.',
    ...
    `alamat` VARCHAR(191) NOT NULL DEFAULT 'Jl. Desa No.1, Lidi, Lidi, Nusa Tenggara Timur',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
