...
import { Newspaper, Calendar, Search, ArrowLeft, ArrowRight, UserCircle } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-emerald-200 mt-2">Informasi terkini dari Desa Sukamaju</p>
        </div>
      </div>
              ...
              >
                ...
                <CardContent className="p-5">
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <span className="text-xs text-gray-500">{berita.author?.name || 'Admin'}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
...
export function BeritaDetail() {
  ...
  if (!berita) return (
    <div className="text-center py-20">
      ...
      <Button onClick={() => setCurrentPage('berita')} className="mt-4 bg-emerald-600 hover:bg-emerald-700">Kembali</Button>
    </div>
  )
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl md:text-4xl font-bold leading-tight">{berita.title}</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        {berita.image && (
          <img src={berita.image} alt={berita.title} className="w-full h-64 md:h-96 object-cover rounded-xl mb-8 shadow-lg" />
        )}
