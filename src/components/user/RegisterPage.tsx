...
import { UserPlus, Loader2, Trees, ArrowLeft, CheckCircle2 } from 'lucide-react'
...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.username || !form.password || !form.name) {
      toast({ title: 'Error', description: 'Username, password, dan nama lengkap harus diisi', variant: 'destructive' })
      return
    }
      ...
      <Card className="w-full max-w-md border-0 shadow-2xl max-h-[95vh] overflow-y-auto">
        <CardContent className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">Buat akun untuk mengakses layanan desa</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                maxLength={16}
              />
              <p className="text-xs text-gray-400 mt-1">Diisi jika Anda warga Desa Sukamaju</p>
            </div>
          ...
          <div className="mt-4 p-4 bg-amber-50 rounded-lg border border-amber-200">
            <p className="text-xs text-amber-700 font-medium mb-1">ℹ️ Informasi:</p>
            <p className="text-xs text-amber-600">
              Akun yang didaftarkan otomatis berperan sebagai <strong>Warga</strong>. 
              Dengan akun warga, Anda dapat mengajukan surat, chat dengan admin desa, 
              dan mengakses layanan desa lainnya.
            </p>
          </div>
        </CardContent>
      </Card>
